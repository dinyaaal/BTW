(() => {
    ...
    function initSliders() {
        if (document.querySelector(".gallerySwiper")) var gallerySwiper = new swiper_core_Swiper(".gallerySwiper", {
        ...
        if (document.querySelector(".gallerySwiper2")) new swiper_core_Swiper(".gallerySwiper2", {
    ...
    if (document.querySelectorAll("[data-prlx-parent]")) document.querySelectorAll("[data-prlx-parent]").forEach((parent => {
        ...
        if (!thresholdWidth || screenWidth >= thresholdWidth) modules_flsModules.parallax = new parallax_Parallax(document.querySelectorAll("[data-prlx-parent]"));
    }));
    ...
    const playButton = document.querySelector(".hero__play");
    ...
    if (popupVideo) {
        ...
        popupVideo.addEventListener("click", (function(event) {
            if (!popupBody.contains(event.target)) hidePopup();
        }));
    }
    function showPopup() {
        iframe.src = iframeSrc;
        popupVideo.classList.remove("hidden");
        popupVideo.classList.add("flex");
        setTimeout((() => {
            popupVideo.classList.add("opacity-100");
        }), 20);
    }
    function hidePopup() {
        popupVideo.classList.add("opacity-0");
        popupVideo.classList.remove("opacity-100");
        iframe.src = "";
        setTimeout((() => {
            popupVideo.classList.add("hidden");
            popupVideo.classList.remove("flex");
        }), 500);
    }
    window["FLS"] = true;
    isWebp();
